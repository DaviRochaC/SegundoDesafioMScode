...
$assunto = 'Recuperar senha - Painel Administrativo da Graphic'; // Armazena a mensagem do assunto em uma variável.
...
include('../../../../views/admin/emails/mensagemAdminRedefenirSenha.php'); // Inclui o arquivo passado. 
