...
$orcamentos = $orcamentoModel->busca('status_orcamento_id', 3, false);
...
<head>
    ...
    <title> Orçamentos cancelados</title>
...
<body>
    ...
    <?php foreach ($orcamentos as $orcamento) { ?>
        <!-- Modal -->
        <div class="modal fade" id="motivo<?= $orcamento['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Motivo do cancelamento</h5>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <li class="list-group-item">
                                    ...
                                    <p><?= $orcamento['motivo_status_orcamento'] ?></p>
